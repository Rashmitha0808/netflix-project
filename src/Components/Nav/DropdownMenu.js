      ...
      <ul className="dropdown_lists">
        <Link className="links" to="/">
          <li className="dropdown_list">
            <img
              src="https://occ-0-6624-2164.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABZ2iWyDq0fR9TY_uztNZ4TcwWkPPdS2NdTtUt3EHjC_rkiEAexSxSUfbrAYTaiI5pcHVs5QMIAhgo1tVaDJr67VjRcr_ZCw.png?r=cad"
              alt="avatar-img"
        ...
        <Link className="links" to="https://help.netflix.com/en/">
          <li className="dropdown_list help_dropdown">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
